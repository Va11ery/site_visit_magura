    ...
    return {
      ...
      data: [
        ...
        },
        {
          ...
          title: "Личная охрана",
          img: sec,
          text: "&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; Личная охрана доступна в любое время, также все охранники вооружены огнестрельным оружием. Обеспечение безопасности охраняемого лица, независимо от того, какого рода опасность может ему угрожать – целенаправленное покушение или форс-мажорные обстоятельства. <br  /><br /> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; В компании ОО «КГБ» вы можете заказать различные услуги, включая: <br /> - личная охрана на час; <br> - постоянно личная охрана и сопровождение; <br > - личный охранник для встречи клиента в аэропорту; <br>- охрана на время проведения определенных торжественных мероприятий.",
        },
        {
          path: "events",
